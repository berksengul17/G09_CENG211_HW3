...
public class Manufacturer2 extends Manufacturer{
	...
	public Manufacturer2() {
		super();
		this.furnitureList = FileIO.readFile("Manufacturer2Furnitures.csv");
		this.materialList = FileIO.readFile("Manufacturer2Materials.csv");
	}
	...
	public void produceFurnitures(int dayValue) {
		...
		ArrayList<String[]> furnituresToProduce = initializeOrders(dayValue);
		
		while(furnituresToProduce.size() != 0) {
			// FIFO
			String[] order = furnituresToProduce.get(0);
	...
	private ArrayList<String[]> initializeOrders(int dayValue){
		
		ArrayList<String[]> furnituresToProduce = new ArrayList<>();
